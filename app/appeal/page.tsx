  ...
  return (
    <main style={{ background: "#f7f7f7", minHeight: "100vh" }}>
      <section style={wrapStyle}>
        ...
        <h1 style={{ fontSize: 30, margin: "18px 0 8px" }}>異議申立てフォーム</h1>

        <p style={{ color: "#666", margin: 0 }}>
          掲載内容が事実と異なる、誤解を招く、補足が必要である等の場合は、以下の内容を記入して送信してください。
          内容確認後、修正、注記、非公開化、削除等を検討します。
        </p>

        <form
          action="mailto:notepc_repair@yahoo.co.jp"
          method="post"
          encType="text/plain"
          style={formStyle}
        >
          ...
          <input id="targetUrl" name="異議申立て対象URL" type="url" required style={inputStyle} />
          ...
          <textarea
            ...
            required
            style={textareaStyle}
            placeholder="例：掲載内容のどの部分が事実と異なるか、どのような修正を希望するか等"
          />

          <label style={labelStyle} htmlFor="evidence">
            根拠資料URL・補足情報（任意）
          </label>
          <textarea id="evidence" name="根拠資料・補足情報" style={textareaStyle} />
